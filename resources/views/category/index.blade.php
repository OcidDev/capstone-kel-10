  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="row g-3" action="{{ route('category.save')}}" method="POST"  enctype="multipart/form-data">
          @csrf
            <div class="col-12">
              <label for="name" class="form-label">Nama Kategori</label>
              <input type="text"  placeholder="Nama Kategori" id="name" name="name" class="form-control" >
            </div>
            <div class="col-12">
...
<div class="modal fade" id="edit{{ $item->id }}" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="row g-3" action="{{ route('category.edit',$item->id)}}" method="POST"  enctype="multipart/form-data">
          @csrf
            <div class="col-12">
              <label for="name" class="form-label">Nama Kategori</label>
              <input type="text" value="{{ $item->name }}"  placeholder="Nama Kategori" id="name" name="name" class="form-control" >
            </div>
            <div class="col-12">
              <label for="description"  class="form-label">Deskripsi</label>
