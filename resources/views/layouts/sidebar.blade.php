...
<aside id="sidebar" class="sidebar">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
        <a class="nav-link {{ $menu == 'master3' ? '' : 'collapsed' }}" data-bs-target="#master-data3" data-bs-toggle="collapse" href="#">
          <i class="bi bi-layout-text-window-reverse"></i><span>Riwayat Inventaris</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="master-data3" class="nav-content  {{ $menu == 'master2' ? '' : 'collapse' }}" data-bs-parent="#sidebar-nav">
          <li>
