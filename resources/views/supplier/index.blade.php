                                ...
                                @foreach ($data_supplier as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" class="d-flex" action="{{ route('supplier.delete', $item->id) }}">
                ...
                <div class="modal-body">
                    <form class="row g-3" action="{{ route('supplier.save') }}" method="POST">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" placeholder="Nama Supllier" id="name" name="name"
                                class="form-control">
                        </div>
                        <div class="col-12">
        ...
        <div class="modal fade" id="edit{{ $item->id }}" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="row g-3" method="POST" action="{{ route('supplier.edit', $item->id) }}"
                            method="POST">
                            @csrf
                            <div class="col-12">
                                <label for="name" class="form-label">Nama Supplier</label>
                                <input type="text" value="{{ $item->name }}" placeholder="Nama Supllier"
                                    id="name" name="name" class="form-control">
                            </div>
                            <div class="col-12">
                                <label for="phone" class="form-label">No. Telp</label>
                                <input id="phone" value="{{ $item->phone }}" placeholder="No. Telp" name="phone"
                                    type="text" class="form-control">
                            </div>
                            <div class="col-12">
                                <label for="address" class="form-label">Alamat</label>
                                <input id="address" value="{{ $item->address }}" placeholder="Alamat" name="address"
                                    type="text" class="form-control">
                            </div>
                    </div>
                    <div class="modal-footer">
